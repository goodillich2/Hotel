...
public class RoomReservationListController {
    ...
    public String deleteRoomReservation(long id, HttpServletRequest request){
        ...
        //    return String.format("redirect:reservationList.html?%s", queryString);//ми робимо перенаправлення, але зберігаємо параметри сторінок
        //  return "reservationList.html";
        return "deleteInfo";
    }

    private String prepareQueryString(String queryString) {//np., did=20&page=2&size=20
        return queryString.substring(queryString.indexOf("&")+1);//обріжте параметр did, інакше deleteVihicle буде викликано знову
    }
